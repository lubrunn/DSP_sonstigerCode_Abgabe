def tweet_collector(retweet,lan,date_range_input,path_raw,date_list):
    ...
    def get_sentiment(text):
       ...
       for date in date_list:
        ...
        # initilalize tweets list
            ...
            tweet.to_csv(r"C:\Users\simon\OneDrive - UT Cloud\Eigene Dateien\Data\Twitter\sentiment\Shiny_files\all_tweets.csv",mode = "a", 
